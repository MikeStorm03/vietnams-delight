package com.msg.vietnamsdelight.multiloader_compat.vanilla_classes;

import com.msg.vietnamsdelight.multiloader_compat.ModClass;
import com.msg.vietnamsdelight.multiloader_compat.ModClass.ModMethod;
...
public class MinecraftMethods {
    ...
    private static final ModMethod getGrowthSpeedMethod(){
        Class<?> firstArg;
        String argClassName = "";
        try {
