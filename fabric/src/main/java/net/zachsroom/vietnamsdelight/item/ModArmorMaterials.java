...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> NONLA = Registry.registerForHolder(BuiltInRegistries.ARMOR_MATERIAL,
                                                                                ResourceLocation.fromNamespaceAndPath(VietnamsDelight.MOD_ID, "non_la"),
                                                                                ...
                                                                                List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(VietnamsDelight.MOD_ID, "non_la"))),
                                                                                0,
                                                                                0));
}
